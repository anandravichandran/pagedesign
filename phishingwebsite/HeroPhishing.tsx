...
// import React from 'react'
// import {Spotlight} from '@/src/components/ui/Spotlight';
// import HeroAnimation from './HeroAnimation' // Ensure the correct path and component name
// import {motion} from "framer-motion"
// // Uncomment the components if you intend to use them
// // import { TextGenerateEffect } from "./ui/TextGenerateEffect";
// // import MagicButton from "./ui/MagicButton";
...
//                 </motion.ul>
//                 <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.3, delay:1.5}} className='mt-10 flex flex-col items-center sm:flex-row gap-3'>
//                     <a href="/" className='w-full sm:w-auto bg-white text-black py-3 px-4 rounded-lg flex items-center justify-center font-medium shadow-md shadow-white/20 border border-transparent hover:bg-transparent hover:text-white transition-all hover:border-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white'>Get Started</a>
//                 </motion.div>
//             </div>
//         </div>
//       </div>
